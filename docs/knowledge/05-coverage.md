...
- **D-043**: Charge re-deferral when ahead of schedule — no C-NNN
  trace. Optimises self-use time during solar surplus but no constraint
  captures "maximise self-use during cheap-rate charging".
...
- **Design decisions**: 44 (D-001 through D-045, D-024 retired)
- **Fully covered**: 24 (69%)
