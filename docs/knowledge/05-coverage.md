...
|---|---|---|---|
| C-001 No grid import during discharge | D-001, D-002, D-003, D-004, D-005 | `TestCalculateDischargePower` (16), `TestShouldSuspendDischarge` (13), `TestDischargePowerFeedinConstraint` (8), `TestCalculateDischargeDeferredStart` (11) | COVERED |
...
- `test_sensor.py::TestBatteryForecastSensor` (10 tests) — may protect
