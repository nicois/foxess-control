...
| C-037 Grid export limit awareness | D-002, D-005, D-044 | `TestGridExportLimitDeferral` (4), `test_deferred_countdown_with_grid_export_limit_and_consumption` | COVERED |
