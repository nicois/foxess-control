...
| C-024 Safe state on failure | D-023, D-025, D-026, D-031, D-032, D-034 | `TestCallbackExceptionSafety` (2), `TestTransientApiErrorResilience` (3), `TestStaleWorkModeAfterCleanupFailure` (2), `test_returns_inverter`, `test_raises_when_no_entries`, `TestRecoverSessions` (13), `TestReloadRecovery` (14 E2E) | COVERED |
