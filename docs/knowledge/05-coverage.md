...
| C-024 Safe state on failure | D-023, D-025, D-026, D-031, D-032, D-034 | `TestCallbackExceptionSafety` (2), `TestTransientApiErrorResilience` (3), `TestStaleWorkModeAfterCleanupFailure` (2), `test_returns_inverter`, `test_raises_when_no_entries`, `test_session_recovery_after_restart` | COVERED |
| C-025 Session boundary cleanliness | D-026, D-032 | `TestSessionBoundaryCleanness` (2), `TestStaleWorkModeAfterCleanupFailure` (2), `test_session_recovery_after_restart` | COVERED |
...
| C-029 E2E for HA-dependent behaviour | -- | `tests/e2e/test_e2e.py` (46), `tests/e2e/test_ui.py` (42) | ACCEPTED |
